func @conv1d_scalar_unrolled(%input : memref<16xf32>, %filter : memref<3xf32>, %output : memref<14xf32>) 
  ...
  memref.store %x0, %output[%c0] : memref<14xf32>
  //vector.print %x0 : f32
  ...
  memref.store %x1, %output[%c1] : memref<14xf32>
  //vector.print %x1 : f32
  ...
  memref.store %x2, %output[%c2] : memref<14xf32>
  //vector.print %x2 : f32
  %x3 = scf.for %j = %c0 to %c3 step %c1 iter_args(%acc = %f0) -> (f32) {
    %start_idx = constant 3 : index
    %idx = addi %start_idx, %j : index
    %0 = memref.load %input[%idx] : memref<16xf32>
    %1 = memref.load %filter[%j] : memref<3xf32>
    %3 = mulf %0, %1 : f32
  ...
  memref.store %x3, %output[%c3] : memref<14xf32>
  //vector.print %x3 : f32
  ...
  memref.store %x4, %output[%c4] : memref<14xf32>
  //vector.print %x4 : f32
  ...
  memref.store %x5, %output[%c5] : memref<14xf32>
  //vector.print %x5 : f32
  ...
  memref.store %x6, %output[%c6] : memref<14xf32>
  //vector.print %x6 : f32
  ...
  memref.store %x7, %output[%c7] : memref<14xf32>
  //vector.print %x7 : f32
  ...
  memref.store %x8, %output[%c8] : memref<14xf32>
  //vector.print %x8 : f32
  ...
  memref.store %x9, %output[%c9] : memref<14xf32>
  //vector.print %x9 : f32
  ...
  memref.store %x10, %output[%c10] : memref<14xf32>
  ...
  memref.store %x11, %output[%c11] : memref<14xf32>
  ...
  memref.store %x12, %output[%c12] : memref<14xf32>
  ...
  memref.store %x13, %output[%c13] : memref<14xf32>
...
func @main() {
  ...
  scf.for %arg0 = %c0 to %iters step %c1 {
    call @conv1d_scalar_unrolled(%input, %filter, %output) : (memref<16xf32>, memref<3xf32>, memref<14xf32>) -> ()
  }
