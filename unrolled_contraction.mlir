...
func @conv1d_unrolled_contraction(%input : memref<${M}xf32>, %filter : memref<${K}xf32>, %output : memref<${N}xf32>) 
...
func @main() {
  ...
  scf.for %arg0 = %c0 to %iters step %c1 {
    call @conv1d_unrolled_contraction(%input, %filter, %output) : (memref<${M}xf32>, memref<${K}xf32>, memref<${N}xf32>) -> ()
  }
